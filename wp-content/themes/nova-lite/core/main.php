...
function novalite_template($id) {
	...
	$template = array ("full" => "span12" , "left-sidebar" => "span4" , "right-sidebar" => "span8" );
...
function novalite_new_excerpt_more() {
	...
	global $post;
	return '<div id="button"><a class="button" href="'.get_permalink($post->ID).'" title="More">  ' . __( "Read More","wip") . ' →</a></div>';
